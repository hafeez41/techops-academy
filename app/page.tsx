        ...
        <div className="mx-auto max-w-7xl">
          <motion.div {...scrollReveal} className="mb-14">
            ...
            <p className="mt-3 text-muted-foreground max-w-xl">
              Structured curriculum packages designed to take you from beginner to job-ready. Flexible payment plans available.
            </p>
          </motion.div>
                ...
                >
                  <Card className="group h-full flex flex-col border-border/60 hover:border-brand/40 hover:shadow-lg hover:shadow-brand/5 transition-all duration-300">
                    <CardContent className="flex flex-col gap-5 p-6 flex-1">
                      ...
                      {/* Payment plans */}
                      <div className="border border-border/40 rounded-lg p-3 bg-muted/30">
                        <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2">Payment options</p>
